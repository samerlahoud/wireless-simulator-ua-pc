...
set(gca,'XTickLabel',{'BR+BR', 'BR+Optim', 'Co-ch+PR', 'Sep-ch+SC-First', 'Co-ch+Power', 'BR+Power'})
...
xlabel('Rate (Mbits/s)');
set(gca,'XScale','log');
legend({'BR+BR', 'BR+Optim', 'Co-ch+PR', 'Sep-channel+SC-First', 'Co-channel+Power', 'BR+Power'}, 'Location', 'NorthWest');
hold off;
