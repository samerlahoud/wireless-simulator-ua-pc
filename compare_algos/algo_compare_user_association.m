...
femto_first_ua = femto_first_association_hetnet(sinr);
[femto_first_rate, femto_first_obj] = ua_hetnet_objective_computation(peak_rate, femto_first_ua);
...
save(result_file_name, 'sinr_based_ua', 'sinr_based_rate', 'sinr_based_obj', ...
    ...
    'femto_first_ua', 'femto_first_rate', 'femto_first_obj', ...
