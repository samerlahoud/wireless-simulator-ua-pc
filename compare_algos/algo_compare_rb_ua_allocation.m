function [] = algo_compare_rb_ua_allocation(rx_power, BS_to_BS_pathloss, femto_demand, run_instance)
global netconfig;
...
m3_rx_RB_power = rx_power;
m4_rx_RB_power = rx_power;
m5_rx_RB_power = rx_power;
m6_rx_RB_power = rx_power;
...
[m1_ua, m1_ua_nb_rounds] = best_response_pf_association_hetnet_gradient(m1_peak_rate); %% This is the slowest algorithm to converge
...
[m4_peak_rate, m4_sinr] = ua_hetnet_initial_sinr_computation(rx_power, m4_RB_allocation);
m4_ua = small_cell_first_association_hetnet(rx_power);
...
[m5_peak_rate, m5_sinr] = ua_hetnet_initial_sinr_computation(rx_power, m5_RB_allocation);
...
% Best response RB allocation + Power-Based UA
...
save(result_file_name, 'm1_RB_allocation', 'm1_peak_rate', 'm1_sinr', 'm1_ua', 'm1_rate', 'm1_obj', ...
    ...
    'm6_RB_allocation', 'm6_peak_rate', 'm6_sinr', 'm6_ua', 'm6_rate', 'm6_obj', 'm6_nb_rounds', ...
