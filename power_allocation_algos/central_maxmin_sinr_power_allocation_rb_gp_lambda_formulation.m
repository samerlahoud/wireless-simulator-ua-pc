function [power_allocation_matrix, sinr_matrix] = central_maxmin_sinr_power_allocation_rb_gp_lambda_formulation(pathloss_matrix, BS)
% Maximize minimum SINR in a downlink multi-cell network with a lambda approach
