...
function [power_allocation_matrix,sinr_matrix] = central_ee_maxlog_sinr_power_allocation_gradient(pathloss_matrix, BS)
...
%     end
%     hold off
    %ee_objective_computation(sinr_matrix, power_allocation_matrix)
