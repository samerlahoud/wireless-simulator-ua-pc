...
% Kinda Khawam
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [complete_time]=algo_compute_ee(netconfig, BS, pathloss_matrix, run_instance)
...
result_file_name = sprintf('./results-compute-ee-%dusers-%dsectors-%dRBs-%dW-%drun.mat',...
    nb_users_per_sector,nb_sectors,nb_RBs,max_power_per_sector, run_instance);

tic
[ee_power_allocation_matrix,ee_sinr_matrix] = ...
    central_ee_maxlog_sinr_power_allocation_rb_gp(netconfig, pathloss_matrix, BS);
complete_time=toc;
...
save(result_file_name, 'netconfig', 'BS', 'pathloss_matrix', 'ee_sinr_db_vector', ...
    'ee_sinr_db_sorted_vector', 'ee_power_db_vector', 'ee_power_db_sorted_vector', ...
    'ee_power_db_vector_per_user', 'pathloss_db_vector');